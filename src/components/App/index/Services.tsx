...
const servicesData: Record<string, Service> = {
  ...
  7: {
    ...
    content: [`Мы имеем большой опыт в области работы с собственниками недвижимости и арендаторами. Мы знаем юридические аспекты управления арендными портфелями, структурируем сделки по заключению, сопровождению, продлению арендных отношений, анализу и реструктуризации портфелей недвижимости. Мы сопровождали инвестиционные проекты в сфере недвижимости в России и за рубежом. Наши услуги включают в себя создание инвестиционных структур в России и других юрисдикциях для приобретения, финансирования и управления недвижимостью, сделки Build-to-suit, сделки с SPV.`, `Мы также консультируем по вопросам прав на землю и водные ресурсы, приобретения земельных участков для целей строительства зданий и сооружений в рамках реализации крупных операционных и инфраструктурных проектов. Мы готовим для наших клиентов договоры на проектирование и строительство и участвуем в переговорах по ним, а также помогаем обеспечить комплаенс в области экологических требований, промышленной безопасности и иных регуляторных требований.`],
  },
  8: {
    ...
    content: [
      `Опыт юристов Korostelev & Partners, полученный, в том числе, в Федеральном агентстве по недропользованию (государственный орган, выдающий лицензии на право пользования недрами), позволяет консультировать российских и иностранных клиентов по любым юридическим вопросам, возникающим на различных этапах жизненного цикла проектов по добыче нефти, газа и твердых полезных ископаемых – от геологического изучения, разведки и разработки месторождений до реализации продукции.`,
      `Управляющий партнер Korostelev & Partners Максим Коростелёв прекрасно ориентируется в операционных и регуляторных аспектах недропользования имеет опыт оформления и переоформления лицензий на право пользования недрами, установления факта открытия месторождения, поставки запасов на баланс и оспаривания актов государственных органов в сфере недропользования.`,
      ...
      `Наши услуги включают в себя:
          • Сопровождение сделок M&A в сфере недропользования;
          • Сопровождение создания совместных предприятий в сфере недропользования;
          • Консультирование по вопросам государственного регулирования и надзора за деятельностью в области недропользования;
          • Консультирование по вопросам реализации нефти, газа и твердых полезных ископаемых.`,
    ],
  },
  9: {
