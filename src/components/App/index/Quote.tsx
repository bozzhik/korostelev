  ...
  return (
    <section id="quote" data-section="quote-index" className="relative z-20 flex flex-col items-end gap-10 p-20 pt-32 sm:gap-20 sm:pt-20 sm:px-4">
      <div className="grid grid-cols-2 gap-20 sm:gap-7 sm:grid-cols-1">
        <Text type="h5" className="leading-normal sm:leading-[1.2]" text="После многих лет работы в крупных юридических компаниях я понял одно: главное — это доверие и партнерство. Для нас каждый клиент — это не просто дело, а настоящая история, в которой мы готовы участвовать. в которой мы готовы участвовать. В которой мы готовы участвовать." />
        <Text type="h5" className="leading-normal sm:leading-[1.2]" text="Давайте делать этот путь вместе. Я уверен, что совместными усилиями мы сможем справиться с любыми вызовами и добиться отличных результатов! Давайте делать этот путь вместе. Я уверен, что совместными усилиями." />
      </div>
