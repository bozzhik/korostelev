...
const teamData = {
  ...
  2: {
    ...
    content: {
      description: [
        ...
        'За время работы в Объединенной авиастроительной корпорации (более 7 лет с 2012 по 2019 год) организовал претензионно-исковую работу в компании «с нуля». Благодаря участию Станислава было выиграно более 15 дел на сумму, превышающую 1 млрд рублей. В сферу ответственности Станислава входило также представление интересов компании во время проведения проверок Федеральной налоговой службы, Генеральной прокуратуры, ФАС России.',
        'Профессионально защищает интересы организаций во внесудебном и судебном порядке, а также при взаимодействии с органами государственной власти. Знает специфику работы по гособоронзаказу и государственных закупок. Дипломированный медиатор.',
  ...
  3: {
    ...
    content: {
      description: ['Евгений Марковский является Партнёром Korostelev & Partners в сфере недвижимости и строительства. Евгений является экспертом в области работы с собственниками недвижимости, арендаторами, управлению арендными портфелями, структурированию сделок по заключению, сопровождению, продлению арендных отношений, анализу и реструктуризации портфелей недвижимости.', 'До прихода в Korostelev & Partners Евгений был Директором по недвижимости АО "Райффайзенбанк", а ранее – Заместителем начальника управления розничного кредитования АО "Райффайзенбанк". Евгений занимался управлением портфелем недвижимости федеральной сети банка: арендным на сумму 3,5 млрд рублей и собственными активами на сумму 30 млрд рублей. Евгений участвовал в проведении сделок с недвижимостью на сумму до 5,5 млрд рублей. До этого Евгений занимался управлением процессами выдачи розничных кредитов: ипотека, потребительские, автокредиты, организация процесса андеррайтинга и залога.', 'Евгений консультирует клиентов в отношении купли-продажи недвижимости по российскому и английскому праву, реализации крупных операционных и инфраструктурных проектов, структурированию сделок по приобретению и реализации активов, управлению арендным и собственным портфелем недвижимости, реструктуризациях банковских сетей при юридическом слиянии банков, сделок build-to-suit.', 'Образование: МГОУ имени В. С. Черномырдина, специалист, гражданское право; кандидат исторических наук, МПГУ; ANSI PMI PMBOK управление проектами в компании; SixSigma Green Belt, методология управление проектами.', 'Языки: русский, английский.'],
      achievements: {
