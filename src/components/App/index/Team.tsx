  ...
  1: {
    ...
    content: {
      ...
      achievements: {
        ...
        2: 'Совокупный объем закрытых сделок, которые сопровождал Максим, превысил 50 млрд рублей, а совокупное количество реализованных проектов при участии Максима превысило 80',
  ...
  3: {
    ...
    content: {
      description: [
        ...
        'Образование: Российский государственный гуманитарный университет, Институт экономики, управления и права, 2010, специалист; МГЮА имени О.Е. Кутафина, 2021, удостоверение медиатора.',
        'Языки: русский.',
      ],
      achievements: {
