import ElectricTrucksImage from '$/projects/electric-trucks.jpg'
import BridgestoneImage from '$/projects/bridgestone.jpg'
import BoschImage from '$/projects/bosch.jpg'
import KoneImage from '$/projects/kone.jpg'
import HuntsmanImage from '$/projects/huntsman.jpg'
import RaymondImage from '$/projects/raymond.jpg'
import HeatingRadiatorsImage from '$/projects/heating-radiators.jpg'
import GermanTechImage from '$/projects/german-tech.jpg'
import LotteryImage from '$/projects/lottery.jpg'
import ItFundImage from '$/projects/it-fund.jpg'
import MedicalFundImage from '$/projects/medical-fund.jpg'
import OilFundImage from '$/projects/oil-fund.jpg'
import VentureFundImage from '$/projects/venture-fund.jpg'
...
export const projectsData = {
  ...
  13: {
    ...
    image: VentureFundImage,
  },
}

export default function Projects({where}: {where: 'index' | 'projects'}) {
  const isIndex = where === 'index'
  const isProjects = where === 'projects'

  const filteredProjects = Object.entries(projectsData).filter(([, project]) => (isIndex ? project.best : true))

  return (
    <section id={!isProjects ? 'projects' : ''} data-section="projects-index" className={cn('relative z-20 p-8 pt-32 space-y-8 sm:p-4 bg-foreground', isIndex ? 'space-y-8 xl:pt-20 sm:pt-12' : 'sm:space-y-5 xl:pt-28 sm:pt-24')}>
          ...
          <ModalTrigger key={key} type="project" tag={tag} heading={heading} content={content} image={image}>
            <div id="project-card">
              <div className="relative flex flex-col gap-20 text-left duration-200 xl:gap-10 p-7 pt-14 xl:pt-10 bg-background-alt text-foreground group hover:bg-red/80 hover:text-background-alt">
                ...
                <Image quality={100} className="absolute inset-0 w-full h-full -z-20" src={image} alt={heading} />
              </div>
            </div>
          </ModalTrigger>
        ))}
